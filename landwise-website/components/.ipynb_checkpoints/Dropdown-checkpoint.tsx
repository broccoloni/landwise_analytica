  ...
  return (
    <div className={`relative inline-block z-20 ${className}`} ref={dropdownRef}>
      <button
        ...
        className="flex items-center pl-4 pr-2 py-2 bg-gray-200 dark:bg-dark-gray-d dark:text-white text-black rounded focus:outline-none"
      >
      ...
      {isOpen && (
        <ul className="absolute z-10 min-w-24 bg-white dark:bg-dark-gray-d dark:border-dark-gray-c border border-gray-300 rounded shadow-lg mt-1">
          {options.map((option, index) => (
            <li
              ...
              className={`w-full px-4 py-2 cursor-pointer hover:bg-medium-green dark:hover:bg-dark-gray-c dark:hover:text-medium-green hover:text-white border-b border-gray-300 ${
