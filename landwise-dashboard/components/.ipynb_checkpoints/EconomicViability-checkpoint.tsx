  ...
  return (
    <div>
      ...
      <div className="py-4 border-b border-gray-500">
        <div className={`${montserrat.className} text-lg font-semibold`}>Property Value Growth</div>
      ...
      <div className="py-4 border-b border-gray-500">
        <div className={`${montserrat.className} text-lg font-semibold`}>Cost of Land Management</div>
      ...
      <div className="py-4 border-b border-gray-500">
        <div className={`${montserrat.className} text-lg font-semibold`}>Commodity Price Volatility</div>
