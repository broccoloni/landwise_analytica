...
export const calculateGrowingSeason = (data: Record<string,WeatherData>): FrostDates => {    
  ...
  let growingSeasonLength = firstFrost - lastFrost;

  return { firstFrost, lastFrost, growingSeasonLength };
};

export const calculateCornHeatUnits = (data: Record<string,WeatherData>): Record<string, number> => {
...
export const calculateGDD = (data: Record<string, WeatherData>, baseTemp: number): Record<string, number> => {
