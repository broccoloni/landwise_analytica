...
export default function SignUpForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-y-4">
      ...
      <div className="flex flex-col gap-y-2">
        <label htmlFor="realtyGroup" className="text-sm font-medium">
          Realty Group
        </label>
        <input
          type="text"
      ...
      <div className="flex items-center gap-x-2 ml-2">
        ...
        <label htmlFor="agreeToTerms" className="text-sm text-gray-700">
          I agree to the{' '}
          <a href="/terms-of-service" target="_blank" className="text-dark-blue underline">
            Terms of Service
          </a>{' '}
          and{' '}
          <a href="/privacy-policy" target="_blank" className="text-dark-blue underline">
            Privacy Policy
          </a>
          .
        </label>
