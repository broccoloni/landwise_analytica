  ...
  return (
    <div className={`${roboto.className} text-black`}>
      ...
      <div className="px-40 py-10">
        <div className={`${roboto.className} font-bold text-2xl mb-10 text-center text-dark-blue`}>
          Key Benefits of Our Reports
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
          <Container className="transition-transform transform hover:scale-105 duration-200 p-8 bg-white border border-gray-300 rounded-lg shadow-lg">
            <div className="font-semibold text-xl mb-2 text-medium-brown">Data-Driven Objectivity</div>
            <p>
          ...
          <Container className="transition-transform transform hover:scale-105 duration-200 p-8 bg-white border border-gray-300 rounded-lg shadow-lg">
            <div className="font-semibold text-xl mb-2 text-medium-brown">Speed and Efficiency</div>
            <p>
          ...
          <Container className="transition-transform transform hover:scale-105 duration-200 p-8 bg-white border border-gray-300 rounded-lg shadow-lg">
            <div className="font-semibold text-xl mb-2 text-medium-brown">Accurate and Up-to-Date Data</div>
            <p>
          ...
          <Container className="transition-transform transform hover:scale-105 duration-200 p-8 bg-white border border-gray-300 rounded-lg shadow-lg">
            <div className="font-semibold text-xl mb-2 text-medium-brown">Sustainability Focused</div>
            <p>
