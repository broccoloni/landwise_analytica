...
export const useReportsById = (reportId: string|null) => {
...
export const useReportsByCustomerId = (customerId: string | null) => {
  const [reports, setReports] = useState<any[] | null>(null);
  const [isLoading, setIsLoading] = useState<boolean>(true);
  const [error, setError] = useState<string | null>(null);
...
export const useReportsBySessionId = (sessionId: string|null) => {
  const [reports, setReports] = useState<any[] | null>(null);
  const [isLoading, setIsLoading] = useState<boolean>(true);
  const [error, setError] = useState<string | null>(null);
